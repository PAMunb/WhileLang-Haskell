...
type RD = (Id, Label)
type RDEntry = Data.Map.Map Label (Set RD)
type RDExit = Data.Map.Map Label (Set RD)
...
rdEntry :: Label -> Program -> RDExit  -> Set RD
rdEntry l prog exit
...
rdExit :: Label -> Program -> RDEntry -> Set RD

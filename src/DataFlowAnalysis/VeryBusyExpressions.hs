...
type VB = AExp
type VBEntry = Data.Map.Map Label (Set VB)
type VBExit = Data.Map.Map Label (Set VB)
...
vbExit :: Label -> Program -> VBEntry -> Set VB
vbExit l prog entry
...
vbEntry :: Label -> Program -> VBExit -> Set VB

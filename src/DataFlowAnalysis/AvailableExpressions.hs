...
type AE = AExp
type AEEntry = Data.Map.Map Label (Set AE)
type AEExit = Data.Map.Map Label (Set AE)
...
aeEntry :: Label -> Program -> AEExit -> Set AE
aeEntry l prog exit
...
aeExit :: Label -> Program -> AEEntry -> Set AE
